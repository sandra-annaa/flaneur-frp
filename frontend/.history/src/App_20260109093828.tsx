...
function TripDashboard() {
  ...
  const containerStyle = {
    minHeight: '100vh',
    background: 'linear-gradient(135deg, var(--ivory-50) 0%, white 50%, var(--chocolate-50)30 100%)',
  };
  ...
  if (isCheckingAuth) {
    return (
      <div style={{
        ...
        <ProgressSpinner />
        <div style={{ marginLeft: '1rem', color: 'var(--chocolate-900)' }}>
          Loading...
        </div>
      </div>
    );
        ...
        <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <Button
              ...
              icon="pi pi-sign-out"
              style={{
                backgroundColor: 'var(--chocolate-700)',
                borderColor: 'var(--chocolate-700)',
                padding: '0.4rem 1rem',
                height: '36px',
                fontSize: '0.875rem',
                borderRadius: '4px'
            ...
            <Card style={{
              ...
              <div style={{ padding: '20px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
                  <i className="pi pi-history" style={{ fontSize: '1.25rem', color: 'var(--chocolate-800)' }} />
                  <h3 style={{ 
                    fontSize: '1.25rem',
                    fontWeight: 600,
                    color: 'var(--chocolate-900)',
                  ...
                  {userTrips.map(trip => (
                    ...
                    >
                      <div style={{ padding: '15px' }}>
                        ...
                        <div style={{
                          borderTop: '1px solid var(--chocolate-100)',
                          margin: '12px 0',
                          paddingTop: '12px'
                        }} />
          ...
          <div style={{
            ...
            marginTop: '40px',
            paddingTop: '20px',
            borderTop: '1px solid var(--chocolate-200)',
            color: 'var(--chocolate-600)',
            fontSize: '0.75rem'
          }}>
            <p style={{ margin: 0 }}>
        ...
        <Card style={{
          ...
          <div style={{ padding: '24px' }}>
            ...
            >
              <TabPanel header={
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <i className="pi pi-map" style={{ color: 'var(--chocolate-700)' }} />
                  <span style={{ 
                    color: 'var(--chocolate-900)',
                    fontWeight: 500,
                    fontSize: '0.875rem'
              ...
              <TabPanel header={
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <i className="pi pi-suitcase" style={{ color: 'var(--chocolate-700)' }} />
                  <span style={{ 
                    color: 'var(--chocolate-900)',
                    fontWeight: 500,
                    fontSize: '0.875rem'
              ...
              <TabPanel header={
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <i className="pi pi-star" style={{ color: 'var(--chocolate-700)' }} />
                  <span style={{ 
                    color: 'var(--chocolate-900)',
                    fontWeight: 500,
                    fontSize: '0.875rem'
              ...
              <TabPanel header={
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <i className="pi pi-shield" style={{ color: 'var(--chocolate-700)' }} />
                  <span style={{ 
                    color: 'var(--chocolate-900)',
                    fontWeight: 500,
                    fontSize: '0.875rem'

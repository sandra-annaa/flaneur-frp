...
function TripDashboard() {
  ...
  const [userTrips, setUserTrips] = useState<TripData[]>([
    ...
    { id: 1, destination: "Paris, France", startDate: "2024-12-15", duration: 5, travelers: "2 Adults", budget: "Mid-range", activities: "Sightseeing", travelMode: "Flight", accommodation: "Hotel" },
    { id: 2, destination: "Tokyo, Japan", startDate: "2024-11-20", duration: 7, travelers: "Solo", budget: "Luxury", activities: "Food & Culinary", travelMode: "Flight", accommodation: "Hotel" },
  ]);
    ...
    return (
      <div style={{
        ...
        <div style={{ 
          ...
          <strong>DEBUG:</strong> TripDashboard loaded without tripData
        </div>
...
export default function App() {
  return (
    <BrowserRouter>
      <Routes>
        <Route path="/login" element={<div style={{ padding: '50px', textAlign: 'center' }}>
          <h1>Login Page</h1>
          <p>For testing, go to <a href="/dashboard">/dashboard</a></p>
        </div>} />
        <Route path="/signup" element={<div style={{ padding: '50px', textAlign: 'center' }}>
          <h1>Signup Page</h1>
        </div>} />
        
        {/* Direct access to dashboard for testing */}

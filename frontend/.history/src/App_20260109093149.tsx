        ...
        <html>
          ...
          <body>
            <div class="print-header">
              <h1>${tripData.destination} Trip Itinerary</h1>
              <p>${tripData.duration} days • ${tripData.travelers} • ${tripData.budget} budget</p>
            ...
            <div class="print-footer">
              <p>Generated by Flâneur Travel Planner</p>
            </div>
  ...
  return (
    <div className="space-y-6" ref={itineraryRef}>
      <TabView>
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                  <div className="text-sm" style={{ color: 'var(--chocolate-600)' }}>
                    <span>Locations loaded: {realLocations.length}</span>
                  </div>
                  <Button 
        ...
        <TabPanel header="Destination Information">
          <Card 
                  ...
                  >
                    {loading ? (
                      ...
                      <div className="space-y-3">
                        ...
                        <Badge 
                          value={`${realLocations.length} locations`} 
                          className="mt-3"
                          style={{ 
                            backgroundColor: 'var(--chocolate-600)',
                            color: 'var(--ivory-50)'
                      ...
                      <div className="text-center py-6">
                        <i 
                          ...
                          style={{ fontSize: '2rem', color: 'var(--chocolate-300)', marginBottom: '12px' }}
                        />
                        <p style={{ color: 'var(--chocolate-600)' }}>No location data available</p>
                        <Button
                          label="Load Data" 
                          icon="pi pi-refresh" 
                          onClick={loadRealLocations}

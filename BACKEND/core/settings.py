...
SECRET_KEY = 'django-insecure-5^w0a4-!wv6c!e)rjy87dj4@&6p+l!k0cuo8)(sm82=aqpk9@%'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles','rest_framework_simplejwt',
    'rest_framework',
    'corsheaders',
...
FREE_API_CONFIG = {
    'NOMINATIM_USER_AGENT': 'TravelPlannerApp/1.0',
